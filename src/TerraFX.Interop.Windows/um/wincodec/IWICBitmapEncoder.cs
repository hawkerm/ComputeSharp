...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IWICBitmapEncoder
    {
        ...
        {
            return ((delegate* unmanaged<IWICBitmapEncoder*, IWICBitmapFrameEncode**, void**, int>)(lpVtbl[10]))((IWICBitmapEncoder*)Unsafe.AsPointer(ref this), ppIFrameEncode, ppIEncoderOptions);
        }
