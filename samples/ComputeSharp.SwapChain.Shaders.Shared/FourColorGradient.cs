...
internal readonly partial struct FourColorGradient : IPixelShader<float4>
{
    ...
    public float4 Execute()
    {
        ...
        // Draw the image
        float3 layer1 = Hlsl.Lerp(this.ColorOne, this.ColorTwo, Hlsl.SmoothStep(-0.3f, 0.2f, Hlsl.Mul(tuv.XY, Rotate(Hlsl.Radians(-5.0f))).X));
        float3 layer2 = Hlsl.Lerp(this.ColorThree, this.ColorFour, Hlsl.SmoothStep(-0.3f, 0.2f, Hlsl.Mul(tuv.XY, Rotate(Hlsl.Radians(-5.0f))).X));
